...
def train_epoch(epoch):
    ...
    for step, (X, Y, loss_mask, pixel_tensors) in enumerate(train_loader):
        ...
        if (step + 1) % args.save_interval == 0 and (not ddp or dist.get_rank() == 0):
            ...
            ckp = f'{args.save_dir}/sft_vlm_multi_image_{model_config.dim}{moe_path}.pth'
...
def init_model(model_config: VLMConfig):
    ...
    moe_path = '_moe' if model_config.use_moe else ''
    ckp = f'/root/workspace/train_res/sft_vlm_512.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/root/workspace/dataset/sft_vlm_data_multi.jsonl")
    parser.add_argument("--images_path", type=str, default="/root/workspace/dataset/sft_multi_images")
